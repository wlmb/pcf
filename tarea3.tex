...
\begin{questions}
  ...
  \begin{parts}
    ...
    superior de abajo hacia arriba es $Q=Na/L=naL^2$, donde $n=N/L^3$
    ...
    $$
    donde $\bm r$ está en la superficie, $\bm r_1=\bm r-\zeta
    \hat{\bm n}$ es un vector pegado a $\bm r$ pero dentro del medio
    1, $\bm r_2=\bm r+\zeta \hat{\bm n}$ es un vector pegado a $\bm
    r$ pero dentro del medio 2, tomamos el límite $\zeta\to 0^+$ y
  ...
  \begin{parts}
    ...
    \part calculando las cargas inducidas en su superficie y empleando
      luego la definición de momento dipolar.
  \end{parts}
  ...
  $$
  donde $\bm D=\bm E+4\pi \bm P$ es el {\em desplazamiento} y
  ...
  \begin{parts}
    ...
    como $\bm E(t)=\mathrm{Re} \tilde{\bm E}(t)=\mathrm{Re}\bm E_0 e^{-i\omega
      t}$ el dipolo sería
  ...
  \begin{parts}
    ...
    dieléctrica o función dieléctrica ({\em función} pues puede depender de $\omega$).
  \end{parts}
